        ...
        <div className="bg-dark-gray text-white">
            <div className="container border-b border-b-[rgba(255,_255,_255,_0.17)]">
                <div className="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    <div>
                        <Typography variant="h5" className="mb-7">EduSync</Typography>

                        <Typography className="space-y-2" as='ul'>
                            <Typography className="flex items-center gap-2" as='li'><HiOutlineMail /> support.edu@sync.com</Typography>
                    ...
                    <div>
                        ...
                        <Typography as='ul' className="flex items-start flex-col gap-5">
                            ...
                            <Typography className="font-normal" as='li'><Link to='/assignments'>Assignment</Link></Typography>
            ...
            <div className="container py-5">
                <div className="flex items-center justify-between">
                    <Typography>&copy; Copyright 2021, EduSync. all rights reserved.</Typography>
